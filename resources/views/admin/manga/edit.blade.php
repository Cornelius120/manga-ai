                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.manga.update', $manga->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="alternative_titles" class="form-control bg-dark text-white border-secondary" value="{{ old('alternative_titles', $manga->alternative_titles) }}" placeholder="Pisahkan dengan koma jika lebih dari satu">
                        </div>
